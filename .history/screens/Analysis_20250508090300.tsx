...
const Analysis = () => {
  ...
  const videoCacheRef = useRef<VideoCache>(null);
  ...
  const captureFrame = async () => {
    ...
    try {
      ...
      // Extract frame using VideoCache
      const frameData = await videoCacheRef.current?.extractFrame({
        source: videoSource,
      ...
      // Save the frame
      await FileSystem.writeAsStringAsync(frameFilename, frameData, {
