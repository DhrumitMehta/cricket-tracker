...
const Analysis = () => {
  ...
  const primaryVideoRef = useRef<ExpoVideo>(null);
  const secondaryVideoRef = useRef<ExpoVideo>(null);
  ...
  const handlePlaybackStatusUpdate = (status: ExpoVideo.PlaybackStatus) => {
    if (status.isLoaded) {
