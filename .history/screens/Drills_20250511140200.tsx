  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Practice Drills</Text>
      </View>

      <ScrollView 
        style={styles.drillsContainer}
        refreshControl={
          <RefreshControl
      ...
      <Portal>
        <Dialog visible={showAddDrillDialog} onDismiss={() => setShowAddDrillDialog(false)}>
          <Dialog.Title>Add New Drill</Dialog.Title>
          <Dialog.Content>
            <ScrollView>
              <TextInput
                label="Drill Name"
