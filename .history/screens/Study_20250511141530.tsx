...
const Study = () => {
  ...
  const formatFilterLabel = () => {
    if (!filters.category && !filters.type && !filters.source) return 'All Notes';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.filtersContainer}>
        <View style={styles.filterRow}>
          ...
          <View style={styles.filterButtonContainer}>
            <Button
              mode={filters.source ? "contained" : "outlined"}
              onPress={() => setShowSourceDropdown(true)}
              style={styles.filterButton}
              labelStyle={filters.source ? styles.activeFilterLabel : undefined}
            >
