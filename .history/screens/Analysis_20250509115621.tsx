...
const Analysis = () => {
  ...
  const handleExportVideo = async () => {
    try {
      ...
      setIsExporting(true);
      setExportProgress({ current: 0, total: 100, status: 'extracting' });
      ...
      setExportProgress({ current: 30, total: 100, status: 'processing' });
      ...
      setExportProgress({ current: 70, total: 100, status: 'combining' });
      ...
      setExportProgress({ current: 0, total: 100, status: 'error' });
