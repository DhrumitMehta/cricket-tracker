...
const Analysis = () => {
  ...
  const handleSelectArea = (area: { x: number; y: number; width: number; height: number }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.toolbar}>
        ...
        >
          <Icon name="pencil" size={24} color={isDrawingMode ? '#fff' : '#000'} />
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.toolButton, isSelectionMode && styles.activeToolButton]}
          onPress={() => {
            setIsSelectionMode(!isSelectionMode);
            setIsDrawingMode(false);
          }}
        >
          <Icon name="crop" size={24} color={isSelectionMode ? '#fff' : '#000'} />
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Icon name="compare" size={24} color={isSideBySide ? '#fff' : '#000'} />
        </TouchableOpacity>
      </View>
